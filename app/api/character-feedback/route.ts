...
export async function POST(req: NextRequest) {
  ...
  const fieldHintMap: Record<DentalField, string> = {
    保存:
      "保存の問題は、基礎の知識とていねいな手技のイメージが大事な分野だよ。少しずつ積み重ねていけば、ちゃんと力になるよ。",
    補綴:
    ...
    歯周:
      "歯周の問題は、原因から経過、治療までの流れを考える分野だよ。流れを追おうとしているだけでも、国試対策としてすごく価値があるよ。",
    小児:
      "小児の問題は、歯だけじゃなくて成長や気持ちもふくめて考える分野だよ。子どもの姿をイメージしながら考えられているだけで、とてもいい勉強になってるよ。",
    矯正:
      "矯正の問題は、立体的な歯列や長い期間の変化をイメージする分野だよ。頭の中でイメージしようとするだけでも、少しずつコツがつかめてくるよ。",
    予防:
      "予防の問題は、生活習慣や指導まで想像して考える分野だよ。患者さんの生活を思い浮かべながら考えられているだけで、立派な練習になってるよ。",
    その他:
